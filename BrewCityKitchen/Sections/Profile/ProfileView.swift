...
class ProfileView: UIView {
    ...
    private lazy var saveProfileButton: ButtonView = {
        let btn = ButtonView()
        btn.configuration = btn.createButtonFilledConfiguration(title: "Save", background: .black, foreground: .white)
        return btn
    }()
    ...
    private func setupView() {
        ...
        buttonStackView.addArrangedSubview(saveProfileButton)
